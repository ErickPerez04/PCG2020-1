...
void CFiguras::prismaPro(float altura, float largo, float profundidad, GLuint text1, GLuint text2, GLuint text3, GLuint text4, GLuint text5, GLuint text6)  //Funcion creacion prisma
{
...
void CFiguras::prismaPro6x10(float altura, float largo, float profundidad, GLuint text1, GLuint text2, GLuint text3, GLuint text4, GLuint text5, GLuint text6)  //Funcion creacion prisma
{
	...
	glTexCoord2f(6.0f, 10.0f); glVertex3fv(vertice[2]);
...
void CFiguras::prismaPro1(float altura, float largo, float profundidad, GLuint text1, GLuint text2, GLuint text3, GLuint text4, GLuint text5, GLuint text6)  //Funcion creacion prisma
{
	...
	glTexCoord2f(6, 1); glVertex3fv(vertice[7]);
	glTexCoord2f(6, 0.0f); glVertex3fv(vertice[1]);
	glEnd();
	...
	glTexCoord2f(6, 1); glVertex3fv(vertice[5]);
	glTexCoord2f(6, 0.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[2]);
	glEnd();
...
void CFiguras::prismaPro2(float altura, float largo, float profundidad, GLuint text1, GLuint text2, GLuint text3, GLuint text4, GLuint text5, GLuint text6)  //Funcion creacion prisma
{

	GLfloat vertice[8][3] = {
				{0.5*largo ,-0.5*altura, 0.5*profundidad},    //Coordenadas Vértice 1 V1
				{-0.5*largo ,-0.5*altura , 0.5*profundidad},    //Coordenadas Vértice 2 V2
				{-1.0*largo ,-0.5*altura , -0.5*profundidad},    //Coordenadas Vértice 3 V3
				{0.5*largo ,-0.5*altura , -0.5*profundidad},    //Coordenadas Vértice 4 V4
				{0.5*largo ,0.5*altura , 0.5*profundidad},    //Coordenadas Vértice 5 V5
				{0.5*largo ,0.5*altura , -0.5*profundidad},    //Coordenadas Vértice 6 V6
				{-1.0*largo ,0.5*altura , -0.5*profundidad},    //Coordenadas Vértice 7 V7
				{-0.5*largo ,0.5*altura , 0.5*profundidad},    //Coordenadas Vértice 8 V8
	};
...
void CFiguras::prismaPro4(float altura, float largo, float profundidad, GLuint text1, GLuint text2, GLuint text3, GLuint text4, GLuint text5, GLuint text6)  //Funcion creacion prisma
{
	...
	GLfloat vertice[8][3] = {
				...
				{-0.5*largo ,-0.5*altura , 0.5*profundidad},    //Coordenadas Vértice 2 V2
				{-0.5*largo ,-0.5*altura , -0.5*profundidad},    //Coordenadas Vértice 3 V3
				{0.5*largo ,-0.5*altura , -1.0*profundidad},    //Coordenadas Vértice 4 V4
				{0.5*largo ,0.5*altura , 0.5*profundidad},    //Coordenadas Vértice 5 V5
				{0.5*largo ,0.5*altura , -1.0*profundidad},    //Coordenadas Vértice 6 V6
				{-0.5*largo ,0.5*altura , -0.5*profundidad},    //Coordenadas Vértice 7 V7
				{-0.5*largo ,0.5*altura , 0.5*profundidad},    //Coordenadas Vértice 8 V8
	};
...
void CFiguras::prismaPro5(float altura, float largo, float profundidad, GLuint text1, GLuint text2)  //Funcion creacion prisma
{
...
void CFiguras::prismaPro6(float altura, float largo, float profundidad, GLuint text1, GLuint text2, GLuint text3)  //Funcion creacion prisma
{
	...
	glTexCoord2f(0.4f, 0.4f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.4f, 0.4f); glVertex3fv(vertice[4]);
	glEnd();
	...
	glTexCoord2f(0.4f, 0.4f); glVertex3fv(vertice[7]);
	glTexCoord2f(0.4f, 0.4f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[2]);
	glEnd();
...
void CFiguras::prismaPro3(float altura, float largo, float profundidad, GLuint text1, GLuint text2, GLuint text3, GLuint text4, GLuint text5, GLuint text6)  //Funcion creacion prisma
{
	...
	GLfloat vertice[8][3] = {
				...
				{-0.5*largo ,-0.5*altura , 0.5*profundidad},    //Coordenadas Vértice 2 V2
				{-0.5*largo ,-0.5*altura , -0.5*profundidad},    //Coordenadas Vértice 3 V3
				{1.0*largo ,-0.5*altura , -0.5*profundidad},    //Coordenadas Vértice 4 V4
				{0.5*largo ,0.5*altura , 0.5*profundidad},    //Coordenadas Vértice 5 V5
				{1.0*largo ,0.5*altura , -0.5*profundidad},    //Coordenadas Vértice 6 V6
				{-0.5*largo ,0.5*altura , -0.5*profundidad},    //Coordenadas Vértice 7 V7
				{-0.5*largo ,0.5*altura , 0.5*profundidad},    //Coordenadas Vértice 8 V8
	};
...
void CFiguras::cilindro(float radio, float altura, int resolucion, GLuint text1, GLuint text2)
{
	...
	for(int i=0; i <resolucion; i++)
	{
		...
		glBegin(GL_POLYGON);
			...
			glTexCoord2f(1.0, 0.0f); glVertex3fv(v4);
			glTexCoord2f(0.5, 0.5f); glVertex3fv(v5);
		glEnd();
...
void CFiguras::cilindro4(float radio, float altura, int resolucion, GLuint text1, GLuint text2)
{
...
void CFiguras::cilindro2(float radio, float altura, int resolucion, GLuint text1, GLuint text2, GLuint text3)
{
	...
	for (int i = 0; i < resolucion; i++)
	{
		...
		v2[0] = radio * sin(angulo*i);
		v2[1] = 0;
		v2[2] = radio * cos(angulo*i);

		v3[0] = radio * sin(angulo*(i + 1));
		v3[1] = 0;
		v3[2] = radio * cos(angulo*(i + 1));

		v4[0] = radio * sin(angulo*i);
		v4[1] = altura;
		v4[2] = radio * cos(angulo*i);

		v5[0] = radio * sin(angulo*(i + 1));
		v5[1] = altura;
		v5[2] = radio * cos(angulo*(i + 1));

		glBindTexture(GL_TEXTURE_2D, text1);
		glBegin(GL_POLYGON);
		glNormal3f(0.0f, -1.0f, 0.0f);
		glTexCoord2f(0.0, 0.0f); glVertex3f(0.0, 0.0, 0.0);
		glTexCoord2f(1.0, 0.0f); glVertex3fv(v2);
		glTexCoord2f(0.5, 0.5f); glVertex3fv(v3);
		glEnd();
...
void CFiguras::cilindro3(float radio, float altura, int resolucion, GLuint text1, GLuint text2, GLuint text3)
{
